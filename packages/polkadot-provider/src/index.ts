...
export const signerMethods = ["polkadot_accounts", "polkadot_sign", "polkadot_sendTransaction"];
...
export interface PolkadotRpcConfig {
  custom?: {
    [chainId: string]: string;
  };
}

export function getRpcUrl(chainId: string, rpc?: PolkadotRpcConfig): string | undefined {
...
export interface PolkadotProviderOptions {
  chains: string[];
  methods?: string[];
  rpc?: PolkadotRpcConfig;
...
class PolkadotProvider {
  ...
  private rpc: PolkadotRpcConfig | undefined;

  public namespace = "polkadot";
  ...
  constructor(opts?: PolkadotProviderOptions) {
    this.rpc = opts?.rpc;
